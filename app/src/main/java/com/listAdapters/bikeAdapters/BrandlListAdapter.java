 ...
 */
public class BrandlListAdapter extends RecyclerView.Adapter<BrandlListAdapter.ServiceCenterHolder> {
    private  String TAG="serviceCenterListAdapter";
    private ArrayList<VehicleSubModel> beensArrayList;
    private Context context;
    private Activity  mActivity;

    public BrandlListAdapter(Context mContext, ArrayList<VehicleSubModel> s, Activity mActivity) {
