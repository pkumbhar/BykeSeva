...
public class DoForgetPassword extends AsyncTask<String,Void,String> {
    ...
    public DoForgetPassword(Context mContext, Handler mhandler, String  email) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            //http://192.168.0.101:8888/NuclearWheels/vectarestapi/booking/bookBikeGarageFromMobile
            URL url=new URL(ServerUrl.serverurl+"User/foreget?email="+email+"&"+"from=1245236521");
